...
class TestPuzzles extends AnyWordSpec {
  ...
  "Day 15, Task 1" in {
    val dataLines = readInput("/input_day15.txt")
    val response = Day15.task1(dataLines)
    assert(response == 517551)
  }

  "Day 15, Task 2" in {
    val dataLines = readInput("/input_day15.txt")
    val response = Day15.task2(dataLines)
  ...
  "Day 17, Task 2" in {
    val dataLines = readInput("/input_day17.txt")
    val response = Day17.task2(dataLines)
    assert(response == 922)
  }

  "Day 18, Task 1" in {
    val dataLines = readInput("/input_day18.txt")
    val response = Day18.task1(dataLines)
    assert(response == 46334L)
  }

  "Day 18, Task 2" in {
    val dataLines = readInput("/input_day18.txt")
    val response = Day18.task2(dataLines)
    assert(response == 102000662718092L)
  }

  "Day 19, Task 1" in {
    val dataLines = readInput("/input_day19.txt")
    val response = Day19.task1(dataLines)
    assert(response == 397061)
  }

  "Day 19, Task 2" in {
    val dataLines = readInput("/input_day19.txt")
    val response = Day19.task2(dataLines)
    assert(response == 125657431183201L)
  }

  "Day 20, Task 1" in {
    val dataLines = readInput("/input_day20.txt")
    val response = Day20.task1(dataLines)
    assert(response == 680278040)
  }

  "Day 20, Task 2" in {
    val dataLines = readInput("/input_day20.txt")
    val response = Day20.task2(dataLines)
    assert(response == 243548140870057L)
  }
